...
namespace tinyutils
{
    ...
    public :
        ...
        static void Config( ssize_t num_octaves, float persistance, float lacunarity, float noise_scale );
    ...
    private :
        ...
        /// Configures the noise-generator with the given settings
        void _Config( ssize_t num_octaves, float persistance, float lacunarity, float noise_scale );
        ...
        /// Computes the product with the gradient at a given point (perlin-noise helper function)
