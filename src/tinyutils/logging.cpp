...
namespace tinyutils
{
    ...
    void Logger::Release()
    {
        // Clean referencess. If using only macros for logging then all other references should
        // have been deleted once the macro finish execution (so, only these two refs. are active).
